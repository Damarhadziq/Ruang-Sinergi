...
export function Card({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) { return <div className={cn("ui-surface rounded-xl border border-[var(--border)] bg-[var(--surface)]", className)} {...props} />; }
